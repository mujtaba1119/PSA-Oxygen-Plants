...
const EQUIP_CATEGORIES = [
  { group: "Oxygen Generator", items: [{ key: "oxyswing_a", label: "Oxygen Generator" }, { key: "oxyswing_b", label: "Oxygen Generator" }]},
  ...
  { group: "Auxiliary Systems", items: [{ key: "hpox", label: "HPOX 450 Booster" }, { key: "oxycheck", label: "Oxycheck Analyzer" }, { key: "css", label: "Central Supervision System" }, { key: "medgas", label: "Medgas Flow" }, { key: "generator", label: "Diesel Generator" }]},
];
